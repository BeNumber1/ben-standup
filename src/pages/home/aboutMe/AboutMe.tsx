      ...
      <Row>
        ...
        <Article>
          ...
          בן ביטון נולד בבת ים בתאריך 20 לנובמבר 1992, כל ילדותו גדל בעיר הפסטורלית בת ים ובעקבות כך התאהב בעיר ונשאר בו עד עצם היום הזה.
                         בן דתל"ש, הוא שמר שבת ולמד בצעירותו בבתי ספר ממלכתיים דתיים.
            <br />
            לכן בן יודע להתאים את ההופעה שלו לקהלים שונים כולל דתיים
          </P>
          <P>
          בתקופה הלא פשוטה שאנו חווים לאחרונה בן הופיע אינספור הופעות בהתנדבות לחיילים ולמפונים ברחבי הארץ
          <br />
...
לעוד פרטים על בן ועל הופעתו תגללו מטה
            <br />
לפרטים והזמנת הופעה התקשרו ל 052-325-5172
          </P>
