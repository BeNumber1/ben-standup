    ...
    <Container id="about">
      ...
      <Row>
        ...
        <Article>
          ...
          <P>
            בשירותו רצה להיות לוחם והתגייס למשמר הגבול
            <br />
            שם במהלך המסלול שעבר הגיע ליחידה שאין לומר את שמה
            <br />
            לאחר מכן למד הנדסת בניין אז אם אתם מעוניינים
            <br />
            שתיפול לכם המרפסת תפנו אליו בנושא.
            <br />
בן יודע לקחת כל נושא ולהקליל אותו
            <br />
            מאז ומתמיד הוא חשב בצורה קומית על כל דבר שקרה לו בחיים
            <br />
